...
class WeddingDetailViewTests(TestCase):
    ...
    def test_detail_view_of_a_non_existent_wedding(self):
        """
    ...
    def test_detail_view_of_an_existent_wedding(self):
        """
        The detail view of an existent wedding should display correctly.
        """
        w = create_wedding(datetime.datetime.utcnow().replace(tzinfo=utc), self.u1, self.u2)
